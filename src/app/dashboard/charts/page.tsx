...
export default function ChartsPage() {
  ...
  const [selectedCities, setSelectedCities] = React.useState<string[]>(["Anápolis", "Aparecida de Goiânia", "Aracaju"])
  ...
  const primaryVariable = selectedVariables[0] || "Total de Pontos de Embarque"
